package com.mesoft.bootstrapper.mvcconfig;
...
import com.mesoft.bootstrapper.filter.LogbackResponseServletFilter;
import com.mesoft.bootstrapper.filter.RequestMDCServletFilter;
...
public class ServletContextAutoConfigure implements WebApplicationInitializer {
    ...
    public void onStartup(final ServletContext servletContext) throws ServletException {
		...
		final JmxReporter reporter = JmxReporter.forRegistry(jvmMetrics).build();
        reporter.start();
