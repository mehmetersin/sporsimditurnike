package com.mesoft.bootstrapper.filter;

import ch.qos.logback.classic.LoggerContext;

import com.mesoft.bootstrapper.util.ThreadLocalMemoryAppender;
...
public class LogbackResponseServletFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        boolean notHtml = url.endsWith(".js") || url.endsWith(".css") || url.endsWith(".mp4");
